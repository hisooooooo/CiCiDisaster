...
public class GrapplingGun : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        ballRigidbody.gravityScale = 2;
    }

    private void Update()
    {
        Mouse_FirePoint_DistanceVector = m_camera.ScreenToWorldPoint(_input.UltraRawDirection) - gunPivot.position;

        if (_input.GrappleInputStarted)
        {
            SetGrapplePoint();
            _input.GrappleInputStarted = false;
        }
        else if (_input.GrappleInput == 2)
        {
            ...
            {
                RotateGun(m_camera.ScreenToWorldPoint(_input.UltraRawDirection), false);
            }
        ...
        {
            RotateGun(m_camera.ScreenToWorldPoint(_input.UltraRawDirection), true);
        }
    }
